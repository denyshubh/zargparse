...
function zargparse (options, json_path, args) {
  args = args ? args : process.argv;
  json_path = json_path ? json_path : './package.json'; 
  ...
  return (args ? argparse(args, conf) : conf);
}

module.exports = zargparse;
